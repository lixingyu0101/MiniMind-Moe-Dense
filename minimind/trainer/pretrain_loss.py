...
# 读取日志
# -----------------------
dense_train_steps, dense_train_loss = load_train_loss('dense_pretrain.log')
moe_train_steps, moe_train_loss     = load_train_loss('moe__pretrain.log')

dense_epochs, dense_val_loss, dense_val_ppl = load_val('dense_pretrain.log')
moe_epochs, moe_val_loss, moe_val_ppl       = load_val('moe__pretrain.log')
...
plt.tight_layout()
plt.savefig('pretrain_loss_comparison.png', dpi=300)
plt.show()
